...
public class CrearCatedratico extends javax.swing.JInternalFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        if (txtCarnet.getText().isBlank() || txtCarnet.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Codigo es Obligatorio", "Informacion", JOptionPane.ERROR_MESSAGE);
            return;
        }
        Catedratico estudiannte = Desktop.treeAvl.buscar(new Catedratico(txtCarnet.getText(), "", ""));//.getValue();
        
        if (estudiannte == null) {
         estudiannte = new Catedratico(txtCarnet.getText(), txtNombre.getText(), txtDireccion.getText());
           
                Desktop.treeAvl.insertar(estudiannte);
                JOptionPane.showMessageDialog(null, "Catedratico Registrado COrrectamente", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                clearTex();
                return;
            
            
        }
        JOptionPane.showMessageDialog(null, "Catedratico No se Pudo Registrar", "Informacion", JOptionPane.ERROR_MESSAGE);
